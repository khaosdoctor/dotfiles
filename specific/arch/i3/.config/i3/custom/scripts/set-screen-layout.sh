...
xrandr --dpi 120 --output DP-0 --mode 2560x1440 --scale 1x1 --pos 3840x415 --rotate normal --output DP-2 --primary --mode 3840x2160 --scale 0.85x0.85 --pos 0x0 -r 240 --rotate normal
