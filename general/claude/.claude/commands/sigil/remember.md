...
See the sigil-syntax.md file at /Users/lsantos/.claude/skills/sigil/remember/references/sigil-syntax.md for the full format specification.
...
- For each entry, show:
  ```
  Before: "Never mock the database in tests — we got burned when mocked tests passed"
