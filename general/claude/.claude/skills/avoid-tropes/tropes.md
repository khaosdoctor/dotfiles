...
### False Exclusivity ("The Part Nobody Talks About")

Claiming something is secret, unspoken, or overlooked when it adds nothing to the sentence. Phrases like "and this is the part nobody talks about" or "what most people miss" are only valid if you are genuinely pointing to something obscure or underreported. Used as a generic aside, they manufacture false insider drama. Don't use punch lines unless the content actually earns one.
...
Stock phrases and idioms that no one actually uses in normal speech or writing. AI reaches for these because they sound authoritative or vivid, but they read as stiff and unnatural. Avoid forensic drama vocabulary, overused business idioms, and any phrase that sounds like it belongs in a thriller synopsis.
...
**Rule: never use em dashes unless absolutely necessary. For parenthetical asides, always prefer parentheses instead.**

**Avoid patterns like:**
- "The problem -- and this is the part nobody talks about -- is systemic." → write: "The problem (and this is the part nobody talks about) is systemic."
